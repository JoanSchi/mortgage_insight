...
// import 'package:mortgage_insight/model/nl/hypotheek/remove_financierings_norm/norm.dart';
...
// import '../remove_parallel_leningen.dart';
// import 'financierings_last_tabel.dart';
// import '../remove_hypotheek.dart';

// class RemoveBerekenNormInkomen {
//   NormInkomen norm;
...
//         return RemoveGegevensNormInkomen.from(
...
// class RemoveBerekenMaximaleLening {
//   RemoveGegevensNormInkomen gegevens;
...
// class RemoveGegevensNormInkomen {
//   RemoveLastParallelLeningen parallelLeningen;
//   RemoveOptimalisatieLast optimalisatieLast;
...
//   RemoveGegevensNormInkomen.from({
...
//   })  : parallelLeningen = RemoveLastParallelLeningen.from(
//             parallelHypotheken: parallelHypotheken,
//             hypotheek: hypotheek,
//             datum: startDatum),
//         normVersie = 0,
//         optimalisatieLast = RemoveOptimalisatieLast(
//           statusLening:
...
//   factory RemoveGegevensNormInkomen.fromMap(Map<String, dynamic> map) {
//     return RemoveGegevensNormInkomen(
//       parallelLeningen: RemoveLastParallelLeningen.fromMap(
//           map['parallelLeningen'] as Map<String, dynamic>),
//       optimalisatieLast: RemoveOptimalisatieLast.fromMap(
...
//   factory RemoveGegevensNormInkomen.fromJson(String source) =>
//       RemoveGegevensNormInkomen.fromMap(
//           json.decode(source) as Map<String, dynamic>);
// }

// class RemoveLastParallelLeningen {
//   List<RemoveOptimalisatieLast> list;
//   double somLeningen;
//   double somVerduurzaamKosten;

//   RemoveLastParallelLeningen({
//     required this.list,
//     this.somLeningen = 0.0,
//     this.somVerduurzaamKosten = 0.0,
//   });

//   RemoveLastParallelLeningen.from(
//       {required List<RemoveHypotheek> parallelHypotheken,
//       required RemoveHypotheek hypotheek,
...
//       if (termijn != null) {
//         final statusLening = RemoveOptimalisatieLast(
...
//   factory RemoveLastParallelLeningen.fromMap(Map<String, dynamic> map) {
//     return RemoveLastParallelLeningen(
//       list: List<RemoveOptimalisatieLast>.from(
//         (map['list'] as List<int>).map<RemoveOptimalisatieLast>(
//           (x) => RemoveOptimalisatieLast.fromMap(x as Map<String, dynamic>),
//         ),
//       ),
...
//   factory RemoveLastParallelLeningen.fromJson(String source) =>
//       RemoveLastParallelLeningen.fromMap(
//           json.decode(source) as Map<String, dynamic>);
// }

// class RemoveOptimalisatieLast {
...
//   RemoveOptimalisatieLast copyWith({
//     RemoveStatusLening? statusLening,
//     double? lening,
//     double? initieleLening,
//     double? verduurzaamLening,
...
//     int? periode,
//   }) {
//     return RemoveOptimalisatieLast(
...
//   factory RemoveOptimalisatieLast.fromMap(Map<String, dynamic> map) {
//     return RemoveOptimalisatieLast(
...
//   factory RemoveOptimalisatieLast.fromJson(String source) =>
//       RemoveOptimalisatieLast.fromMap(
//           json.decode(source) as Map<String, dynamic>);
// }
...
// berekenIndividueleLast(
//     {required RemoveOptimalisatieLast sn, required SomLeningen somLeningen}) {
