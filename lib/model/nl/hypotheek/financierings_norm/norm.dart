...
class NormInkomen extends Norm {
  List<GegevensNormInkomen> gegevens;
  GegevensNormInkomen? maximumLening;
  ...
  vindMaximumLening() {
    maximumLening = fataleFout
        ? null
        : gegevens.reduce((GegevensNormInkomen a, GegevensNormInkomen b) {
  ...
  @override
  double get totaal {
    final GegevensNormInkomen? g = maximumLening;
  ...
  factory NormInkomen.fromMap(Map<String, dynamic> map) {
    return NormInkomen(
      omschrijving: map['omschrijving'],
      order: map['order']?.toInt(),
      toepassen: map['toepassen'],
      gegevens: List<GegevensNormInkomen>.from(
        (map['gegevens'] as List<int>).map<GegevensNormInkomen>(
          (x) => GegevensNormInkomen.fromMap(x as Map<String, dynamic>),
        ),
      ),
      // fouten: List<String>.from(
      //   (map['fouten'] as List<String>),
  ...
  factory NormInkomen.fromJson(String source) =>
      NormInkomen.fromMap(json.decode(source) as Map<String, dynamic>);
}
