...
class RemoveAflopendKrediet extends RemoveSchuld {
  ...
  void berekenenTermijnBedrag() {
    berekend = StatusBerekening.nietBerekend;
  ...
  void berekenLooptijd() {
    ...
    if (termijnBedragMnd < minTermijnBedragMnd) {
      berekend = StatusBerekening.fout;
  ...
  set berekend(StatusBerekening berekend) {
    super.berekend = berekend;

    if (berekend == StatusBerekening.nietBerekend) {
      somAnn = 0;
      somInterest = 0;
      termijnen.clear();
    }
  ...
  _berekenenTermijnen() {
    ...
    berekend = StatusBerekening.berekend;
  }
  ...
  @override
  RemoveAflopendKrediet copyWith({
    int? id,
  ...
  bool operator ==(Object other) {
    ...
    return other is RemoveAflopendKrediet &&
        other.id == id &&
        other.lening == lening &&
        other.rente == rente &&
  ...
  factory RemoveAflopendKrediet.fromMap(Map<String, dynamic> map) {
    return RemoveAflopendKrediet(
      id: map['id']?.toInt(),
      ...
      berekend: StatusBerekening.values[map['berekend'].toInt()],
  ...
  factory RemoveAflopendKrediet.fromJson(String source) =>
      RemoveAflopendKrediet.fromMap(json.decode(source));
}
