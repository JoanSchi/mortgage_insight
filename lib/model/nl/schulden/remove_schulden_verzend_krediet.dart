...
import 'remove_schulden.dart';
import 'schulden.dart';

class RemoveVerzendhuisKrediet extends RemoveSchuld {
  double totaalBedrag;
  double mndBedrag;
  double slotTermijn;
  int maanden;
  ...
  @override
  RemoveVerzendhuisKrediet copyWith({
    int? id,
    ...
    return RemoveVerzendhuisKrediet(
      id: id ?? this.id,
  ...
  bool operator ==(Object other) {
    ...
    return super == (other) &&
        other is RemoveVerzendhuisKrediet &&
  ...
  factory RemoveVerzendhuisKrediet.fromMap(Map<String, dynamic> map) {
    return RemoveVerzendhuisKrediet(
      id: map['id']?.toInt(),
  ...
  factory RemoveVerzendhuisKrediet.fromJson(String source) =>
      RemoveVerzendhuisKrediet.fromMap(json.decode(source));
}
