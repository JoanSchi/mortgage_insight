...
import 'package:mortgage_insight/routes/navigation_page_items.dart';
import 'routes.dart';
    ...
    return Scrollbar(
        ...
        child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              ...
              // TODO linken
              final bool selected = false; //ref.watch(routeDocumentProvider
                  ...
                  child: _LineUnder(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        mi.title,
                        style:
                            TextStyle(fontSize: 24, color: theme.primaryColor),
                      ),
                    ),
                  ),
                  onTap: () {
