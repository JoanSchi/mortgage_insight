...
final hypotheekDossierBewerkenProvider = StateNotifierProvider<
    HypotheekDossierBewerkenNotifier, HypotheekDossierBewerken>((ref) {
  return HypotheekDossierBewerkenNotifier(HypotheekDossierBewerken.nieuw());
});

class HypotheekDossierBewerkenNotifier
    extends StateNotifier<HypotheekDossierBewerken> {
  HypotheekDossierBewerkenNotifier(super.state);

  void nieuw() {
    state = HypotheekDossierBewerken.nieuw();
  }

  void bewerken(HypotheekDossier hypotheekDossier) {
    state = HypotheekDossierBewerken(hypotheekDossier: hypotheekDossier);
  }
  ...
  void verandering({
    ...
    final vorige = state.hypotheekDossier;
  ...
  void veranderingVorigeWoningKosten({
    ...
    state = state.copyWith(
        hypotheekDossier: vorige.copyWith(
  ...
  bool evaluateBoxVisibility(HypotheekDossier vorige, HypotheekDossier volgende,
      ControllerSliverRowBox controllerSliverRowBox) {
    final zichtbaarVorige =
        HypotheekDossierVerwerken.woningGegevensZichtbaar(vorige);
    final zichtbaarVolgende =
        HypotheekDossierVerwerken.woningGegevensZichtbaar(volgende);
...
class HypotheekDossierBewerken {
  HypotheekDossier hypotheekDossier;

  HypotheekDossierBewerken.nieuw({
    this.hypotheekDossier = const HypotheekDossier(),
  });

  HypotheekDossierBewerken({
    required this.hypotheekDossier,
  });

  HypotheekDossierBewerken copyWith({
    HypotheekDossier? hypotheekDossier,
  }) {
    return HypotheekDossierBewerken(
