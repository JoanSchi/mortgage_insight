...
//   _L.from(RemoveHypotheekProfiel profiel, RemoveHypotheek hypotheek) {
//     int count = 0;
...
//     void addKosten(RemoveHypotheek h) {
...
//     void addVerduurzamen(RemoveHypotheek h) {
...
//     for (RemoveStatusLening s in hypotheek.parallelLeningen.list) {
//       RemoveHypotheek parallel = profiel.hypotheken[s.id]!;
