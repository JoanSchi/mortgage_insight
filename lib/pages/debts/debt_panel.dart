...
import 'package:mortgage_insight/pages/debts/doorlopend_krediet.dart/doorlopend_krediet.dart';
import 'package:mortgage_insight/pages/debts/lease_auto/lease_auto.dart';
import 'package:mortgage_insight/pages/debts/verzend_krediet/verzend_krediet.dart';
    ...
    return MyPage(
        factorTypePageProperties: [
          FactorTypePageProperties(
              ...
              pageProperties: PageProperties(leftBarActions: [
                PageActionItem(
                    voidCallback: () => _messageListeners.invoke(
                        AcceptCancelBackMessage(msg: AcceptCancelBack.back)),
        ...
        bodyBuilder: ({required BuildContext context, required bool nested}) =>
            SelectieNieuwOfBestaandeSchuld(nested: nested));
  }
}
