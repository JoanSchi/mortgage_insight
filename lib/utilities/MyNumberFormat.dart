...
class MyNumberFormat {
  ...
  final textInputFormatters = Map<String, TextInputFormatter>();
  final numberFormats = Map<String, intl.NumberFormat>();
...
class DecimalOnly extends TextInputFormatter {
  ...
  TextEditingValue formatEditUpdate(
    ...
    return matches.length == 0 ? oldValue.copyWith() : newValue.copyWith();
  }
}
