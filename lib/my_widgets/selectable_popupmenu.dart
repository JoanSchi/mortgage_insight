...
class SinglePopupMenuItem<I> extends _PopupMenuItem<I, bool> {
  SinglePopupMenuItem(
...
class GroupPopupMenuItem<I, V> extends _PopupMenuItem<I, V> {
  ...
  @override
  State<_PopupMenuItem<I, V>> createState() => GroupPopupMenuItemState<I, V>();

  @override
  bool represents(SelectedMenuPopupIdentifierValue? n) =>
      groupValueNotifier.value == this.identifierAndValue.value;
}

abstract class _PopupMenuItem<I, V>
...
mixin _PopupMenuItemState<T extends _PopupMenuItem> on State<T> {
  Widget buildChild();
