...
class PersistentHeaderShowOnScreenConfiguration {
  ...
  /// [MyRenderSliverPersistentHeader.minExtent].
  ///
  ...
  /// [MyRenderSliverPersistentHeader.minExtent] or [minShowOnScreenExtent],
  ...
  /// in response to a [RenderObject.showOnScreen] call, in addition to its
  /// [MyRenderSliverPersistentHeader.maxExtent].
  ///
  /// When a floating persistent header is told to show a [Rect] on screen, it
  /// may expand itself to accommodate the [Rect]. The maximum extent that is
  /// allowed for such expansion is either
  /// [MyRenderSliverPersistentHeader.maxExtent] or [maxShowOnScreenExtent],
...
abstract class MyRenderSliverPersistentHeader extends RenderSliver
  ...
  MyRenderSliverPersistentHeader({
    RenderBox? child,
  ...
  ///
  /// This must be implemented by [MyRenderSliverPersistentHeader] subclasses.
  ///
...
abstract class MyRenderSliverScrollingPersistentHeader
    extends MyRenderSliverPersistentHeader {
  /// Creates a sliver that shrinks when it hits the start of the viewport, then
  /// scrolls off.
  MyRenderSliverScrollingPersistentHeader({
    RenderBox? child,
    OverScrollHeaderStretchConfiguration? stretchConfiguration,
  }) : super(
          child: child,
...
abstract class MyRenderSliverPinnedPersistentHeader
    extends MyRenderSliverPersistentHeader {
  /// Creates a sliver that shrinks when it hits the start of the viewport, then
  /// stays pinned there.
  MyRenderSliverPinnedPersistentHeader({
    RenderBox? child,
    OverScrollHeaderStretchConfiguration? stretchConfiguration,
...
/// See also:
///
///  * [MyRenderSliverFloatingPersistentHeader.maybeStartSnapAnimation] and
...
/// [MyRenderSliverScrollingPersistentHeader], but immediately comes back when the
...
abstract class MyRenderSliverFloatingPersistentHeader
    extends MyRenderSliverPersistentHeader {
  /// Creates a sliver that shrinks when it hits the start of the viewport, then
...
/// the start of the viewport like a [MyRenderSliverPinnedPersistentHeader], but
/// immediately grows when the user scrolls in the reverse direction.
///
/// See also:
///
///  * [MyRenderSliverFloatingPersistentHeader], which is similar but scrolls off
