...
@immutable
class MyQuiltedGridTile {
  /// Create a [MyQuiltedGridTile].
  const MyQuiltedGridTile(
    this.mainAxisCount,
    this.crossAxisCount,
...
class MySliverQuiltedGridDelegate extends SliverGridDelegate {
  /// Creates a [SliverQuiltedGridDelegate].
  MySliverQuiltedGridDelegate({
    required this.crossAxisCount,
    required List<MyQuiltedGridTile> pattern,
  ...
  @override
  bool shouldRelayout(MySliverQuiltedGridDelegate oldDelegate) {
...
class _QuiltedTilePattern {
  ...
  final List<MyQuiltedGridTile> tiles;
  final int tileCount;
  ...
  MyQuiltedGridTile tileOf(int index) {
...
class _SliverQuiltedGridLayout extends SliverGridLayout {
  const _SliverQuiltedGridLayout({
    ...
    required this.reverseCrossAxis,
        ...
        crossAxisStride = crossAxisExtent / 2.0 + crossAxisSpacing;
